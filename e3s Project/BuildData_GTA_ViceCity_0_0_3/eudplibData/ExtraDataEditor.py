...
try:
    ...
    def init_wireframe():
        ...
        WireFrameDataEditor.ChangeWireframe(96, 129)
        WireFrameDataEditor.ChangeTranframe(96, 100)
        WireFrameDataEditor.ChangeGrpframe(96, 129)

else:
    InitialWireframe.wirefram(96, 129)
    InitialWireframe.tranwire(96, 100)
    InitialWireframe.grpwire(96, 129)
...
def beforeTriggerExec():
    DoActions([
        ...
        SetMemory(0x660A70 + 192, SetTo, 204),
        SetMemory(0x660A70 + 196, SetTo, 0),
        SetMemory(0x660A70 + 200, SetTo, 0),
        SetMemory(0x660A70 + 204, SetTo, 13434880),
        SetMemory(0x660A70 + 208, SetTo, 0),
        SetMemory(0x660A70 + 212, SetTo, 14090451),
        SetMemory(0x660A70 + 216, SetTo, 14876893),
        SetMemory(0x660A70 + 220, SetTo, 15401191),
        SetMemory(0x660A70 + 224, SetTo, 16056560),
        SetMemory(0x660A70 + 228, SetTo, 16711930),
        SetMemory(0x660A70 + 232, SetTo, 17367300),
        SetMemory(0x660A70 + 236, SetTo, 270),
        SetMemory(0x660A70 + 240, SetTo, 275),
        SetMemory(0x660A70 + 244, SetTo, 18678040),
        SetMemory(0x660A70 + 248, SetTo, 19333410),
        SetMemory(0x660A70 + 252, SetTo, 0),
        SetMemory(0x660A70 + 256, SetTo, 0),
        SetMemory(0x660A70 + 260, SetTo, 19660800),
        SetMemory(0x660A70 + 264, SetTo, 20250928),
        SetMemory(0x660A70 + 268, SetTo, 20906298),
        SetMemory(0x660A70 + 272, SetTo, 21561668),
        SetMemory(0x660A70 + 276, SetTo, 22413646),
        SetMemory(0x660A70 + 280, SetTo, 23462241),
        SetMemory(0x660A70 + 284, SetTo, 24707438),
        SetMemory(0x660A70 + 288, SetTo, 381),
        SetMemory(0x660A70 + 292, SetTo, 385),
        SetMemory(0x660A70 + 296, SetTo, 25493504),
        SetMemory(0x660A70 + 300, SetTo, 0),
        SetMemory(0x660A70 + 304, SetTo, 0),
        SetMemory(0x660A70 + 308, SetTo, 25887112),
        SetMemory(0x660A70 + 312, SetTo, 26345871),
        SetMemory(0x660A70 + 316, SetTo, 26542080),
        SetMemory(0x660A70 + 320, SetTo, 409),
        SetMemory(0x660A70 + 324, SetTo, 27328925),
        SetMemory(0x660A70 + 328, SetTo, 27853221),
        SetMemory(0x660A70 + 332, SetTo, 28377517),
        SetMemory(0x660A70 + 336, SetTo, 28639232),
        SetMemory(0x660A70 + 340, SetTo, 29229497),
        SetMemory(0x660A70 + 344, SetTo, 450),
